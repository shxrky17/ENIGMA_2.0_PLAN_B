...
public class InterviewSession {
    ...
    private String questionsQueueJson;

    @Column(columnDefinition = "TEXT")
    private String interactionLogJson;

    @Column(columnDefinition = "TEXT")
    private String codeSubmissionsJson;
    ...
    public String getQuestionsQueueJson() {
        return questionsQueueJson;
    }

    public String getInteractionLogJson() {
        return interactionLogJson;
    }

    public String getCodeSubmissionsJson() {
        return codeSubmissionsJson;
    }
    ...
    public void setQuestionsQueueJson(String questionsQueueJson) {
        this.questionsQueueJson = questionsQueueJson;
    }

    public void setInteractionLogJson(String interactionLogJson) {
        this.interactionLogJson = interactionLogJson;
    }

    public void setCodeSubmissionsJson(String codeSubmissionsJson) {
        this.codeSubmissionsJson = codeSubmissionsJson;
    }
