...
public class ResumeProfileDTO {
    ...
    public List<String> getGeneratedQuestions() {
    ...
    public void setGeneratedQuestions(List<String> v) {
        this.generatedQuestions = v;
    }
    ...
    public static class Builder {
        ...
        public Builder generatedQuestions(List<String> v) {
            dto.generatedQuestions = v;
            return this;
        }
