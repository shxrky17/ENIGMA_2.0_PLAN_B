...
public class ReportDTO {
    ...
    private List<InterviewContextEntryDTO> interviewContext;
    private List<CodeSubmissionDTO> codeSubmissions;
    private List<CodeApproachItemDTO> codeApproach;
    ...
    public ReportDTO(int overall, String role, String date, String duration,
            ...
            int logicalReasoningScore, int problemSpeedScore,
            List<InterviewContextEntryDTO> interviewContext,
            List<CodeSubmissionDTO> codeSubmissions,
            List<CodeApproachItemDTO> codeApproach) {
        ...
        this.codeApproach = codeApproach;
    }
    ...
    public List<InterviewContextEntryDTO> getInterviewContext() {
        return interviewContext;
    }

    public List<CodeSubmissionDTO> getCodeSubmissions() {
        return codeSubmissions;
    }

    public List<CodeApproachItemDTO> getCodeApproach() {
        return codeApproach;
    }
    ...
    public void setLogicalReasoningScore(int v) {
        this.logicalReasoningScore = v;
    }

    public void setProblemSpeedScore(int v) {
        this.problemSpeedScore = v;
    }

    public void setInterviewContext(List<InterviewContextEntryDTO> v) {
        this.interviewContext = v;
    }

    public void setCodeSubmissions(List<CodeSubmissionDTO> v) {
        this.codeSubmissions = v;
    }

    public void setCodeApproach(List<CodeApproachItemDTO> v) {
        this.codeApproach = v;
    }
}
